...
<div id="templatemo_content_panel_1">
  ...
  <tr>
    <th width="253" bgcolor="#333333"><div align="left" class="style8 style7">Path of Image </div></th>
    <th width="352" bgcolor="#333333"><div align="left" class="style8 style7">Decription</div></th>
	</tr>
  <?php
...
echo "</td>";
echo '<td><a href="delete5.php? caption='.$row['caption'].'">Delete</a></td>';
echo"</td>";
