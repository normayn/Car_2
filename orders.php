  ...
  <div id="templatemo_section_1_1">
    <div id="header">
      <div align="center" class="style5">
	    ...
	    <div id="container">
              <table width="1008" height="70" border="1" align="center" bordercolor="#333333" bgcolor="#333333" class="style6" >
  <caption>&nbsp;
  </caption>
  
  <tr>
    <th width="190" bgcolor="#333333"><div align="left" class="style8 style6">ID</div></th>
    <th width="227" bgcolor="#333333"><div align="left" class="style8 style6">Amount</div></th>
	<th width="227" bgcolor="#333333"><div align="left" class="style8 style6">Service</div></th>
	<th width="222" bgcolor="#333333"><div align="left" class="style8 style6">Confirmation No.</div></th>
    <th width="252" bgcolor="#333333"><div align="left" class="style8 style6">Full Names</div></th>
	<th width="252" bgcolor="#333333"><div align="left" class="style8 style6">Physical Address</div></th>
	<th width="252" bgcolor="#333333"><div align="left" class="style8 style6">Email</div></th>
	<th width="252" bgcolor="#333333"><div align="left" class="style8 style6">Phone Number </div></th>
	<th width="252" bgcolor="#333333"><div align="left" class="style8 style7">Send Email</div></th>
...
echo "</td>";
echo '<td><a href="mail.php?"> <img src="images/2.png" alt="dt" /></a></td>';
echo"</td>";

echo "</td>";
echo '<td><a href="delete2.php? name='.$row['name'].'">Delete</a></td>';
echo"</td>";
